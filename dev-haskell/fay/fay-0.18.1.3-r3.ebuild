...
RDEPEND="dev-haskell/aeson:=[profile?]
	...
	>=dev-haskell/haskell-packages-0.2.3.1:=[profile?] <dev-haskell/haskell-packages-0.3:=[profile?]
	...
	>=dev-haskell/optparse-applicative-0.6:=[profile?] <dev-haskell/optparse-applicative-0.8:=[profile?]
